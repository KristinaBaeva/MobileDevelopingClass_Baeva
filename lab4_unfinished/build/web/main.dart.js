...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C5() {
      return C[5] = dart.constList([0, 0, 5, 1], core.double);
    },
    get C7() {
    ...
    get C6() {
      return C[6] = dart.constList([C[7] || CT.C7, C[8] || CT.C8, C[9] || CT.C9], ui.Color);
    },
    get C10() {
    ...
    get C4() {
      return C[4] = dart.const({
        ...
        [LinearGradient_tileMode]: C[10] || CT.C10,
        [LinearGradient_end]: C[11] || CT.C11,
        [LinearGradient_begin]: C[12] || CT.C12
      });
    },
    get C2() {
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    ...
    build(context) {
      return new scaffold.Scaffold.new({body: new container.Container.new({decoration: C[2] || CT.C2, child: new basic.Column.new({children: T.JSArrayOfWidget().of([])})})});
    }
